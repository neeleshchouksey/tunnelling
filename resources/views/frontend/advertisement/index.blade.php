	  		...
	  		<div class="container">
		  		<div class="banner-content">
					...
					<div class="banner-image">
						<img src="images/advertise-magzine.png" alt="magazines">
					</div>
				...
				<div class="four-block">
					<div class="width-50 pull-left">
						<div class="block-content">
							<h3>PUBLICATION <img src="images/publication.png"></h3>
...
the Tunnelling Industry</p>
					...
					<div class="width-50 pull-left">
					<div class="block-content">
							<h3>audience <img src="images/audiance.png"></h3>
...
practises ensures the<br>relevance of our audience</p>
					...
					<div class="width-50 pull-left">
					<div class="block-content">
							<h3>7000 copies <img src="images/copies.png"></h3>
							<p>A MINIMUM OF PRINTED<br>COPIES DISTRIBUTED FREE<br>OF CHARGE</p>
						</div>
					</div>
					<div class="width-50 pull-left">
					<div class="block-content">
							<h3>Free Ppdf <img src="images/free-pdf.png"></h3>
			...
			<div class="features-row">
				<div class="col-5">
					<div class="fetures-content">
						<div class="icon"><img src="images/profile.png" alt="profile"></div>
						<h5>Managing & Technical<br>Directors</h5>
					</div>
				</div>
				<div class="col-5">
					<div class="fetures-content">
						<div class="icon"><img src="images/chief-enginner.png"></div>
						<h5>Chief<br>Engineers</h5>
					</div>
				</div>
				<div class="col-5">
					<div class="fetures-content">
						<div class="icon"><img src="images/consultants.png"></div>
						<h5>Consultants</h5>
					</div>
				</div>
				<div class="col-5">
					<div class="fetures-content">
						<div class="icon"><img src="images/associate-enginner.png"></div>
						<h5>Associations<br>& Federations</h5>
					</div>
				</div>
				<div class="col-5">
					<div class="fetures-content">
						<div class="icon"><img src="images/purchasing-manager.png"></div>
	  ...
	  <section class="our-circulation text-center">
	  	<div class="container">
			...
			<div class="our-circle-map">
				<img src="images/our-circle.png" alt="our circle">
			</div>
		 </div>
	  </section>
