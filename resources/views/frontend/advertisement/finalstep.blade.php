...
Complete process now.</p>
				...
				<div class="step-btn text-center">
					<button href="#" class="btn-icon shadow-none"><span class="btn-download">check email </span><span class="download-icon"><img src="images/check-mail.png" alt="download-btn"></span></button>
				</div>
