                  ...
                  <div class="row">
                    <div class="col-md-10 col-md-push-1">
                      <div class="">
                        ...
                        {!! Form::open(array('url' => "admin/media-partner-slide/$slide->id","enctype"=>"multipart/form-data","method"=>'put')) !!}
                                  ...
                                  <td>
                                    <select  class="form-control" name="media_id"  required>
                                      @foreach($mediaPartners as $mediaPartner)
                                        @php
                                          $selected = '';
                                          if($mediaPartner->id==$slide->media_id):
                                              $selected = "selected";
                                          endif;
                                        @endphp
                                        <option value="{{$mediaPartner->id}}" {{$selected}}>{{$mediaPartner->title}}</option>
                                      @endforeach
                                    </select>
                                  </td>
                                </tr>
                        ...
                        <div class="img col-md-12">
                            <img src='{{asset("uploads/media-partner-slide/$slide->slide")}}' class="img-lg img-responsive">
                          </div>
